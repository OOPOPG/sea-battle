    ...
    for (int v = -1; v < 2; ++v)
    {
        ...
        for (int h = -1; h < 2; ++h)
        {
            ...
            if (check_h < 0 || check_h > 9)
                continue;
            if (m_cells[check_v][check_h].m_is_ship)
                return false;
        }
    }
    return true;
...
bool Field::SetShip(int num_decks, int cur_ship_index)
{
    ...
    if (num_decks == 1)
    {
        ...
        m_cells[ver][hor].m_is_ship = true;
        m_cells[ver][hor].m_ship_index = cur_ship_index;
    }
        ...
        while (!is_found)
        {
            ...
            if (is_ver)
            {
                if (IsCellAvailable(ver, hor - 1))
                {
                    ...
                    m_cells[ver][hor].m_is_ship = true;
                    m_cells[ver][hor].m_ship_index = cur_ship_index;
                    m_cells[ver][hor - 1].m_is_ship = true;
                    m_cells[ver][hor - 1].m_ship_index = cur_ship_index;
                    is_found = true;
                }
            ...
            else
            {
                if (IsCellAvailable(ver - 1, hor))
                {
                    ...
                    m_cells[ver][hor].m_is_ship = true;
                    m_cells[ver][hor].m_ship_index = cur_ship_index;
                    m_cells[ver - 1][hor].m_is_ship = true;
                    m_cells[ver - 1][hor].m_ship_index = cur_ship_index;
                    is_found = true;
                }
        ...
        while (!is_found)
        {
            ...
            if (is_ver)
            {
                if (IsCellAvailable(ver, hor - 1) && IsCellAvailable(ver, hor - 2))
                {
                    ...
                    m_cells[ver][hor - 1].m_is_ship = true;
                    m_cells[ver][hor - 1].m_ship_index = cur_ship_index;
                    m_cells[ver][hor - 2].m_is_ship = true;
                    m_cells[ver][hor - 2].m_ship_index = cur_ship_index;
                    is_found = true;
                }
            ...
            else
            {
                if (IsCellAvailable(ver - 1, hor) && IsCellAvailable(ver - 2, hor))
                {
                    ...
                    m_cells[ver - 1][hor].m_is_ship = true;
                    m_cells[ver - 1][hor].m_ship_index = cur_ship_index;
                    m_cells[ver - 2][hor].m_is_ship = true;
                    m_cells[ver - 2][hor].m_ship_index = cur_ship_index;
                    is_found = true;
                }
        ...
        while (!is_found)
        {
            ...
            if (is_ver)
            {
                if (IsCellAvailable(ver, hor - 1) && IsCellAvailable(ver, hor - 2) && IsCellAvailable(ver, hor - 3))
                {
                    ...
                    m_cells[ver][hor - 2].m_is_ship = true;
                    m_cells[ver][hor - 2].m_ship_index = cur_ship_index;
                    m_cells[ver][hor - 3].m_is_ship = true;
                    m_cells[ver][hor - 3].m_ship_index = cur_ship_index;
                    is_found = true;
                }
            ...
            else
            {
                if (IsCellAvailable(ver - 1, hor) && IsCellAvailable(ver - 2, hor) && IsCellAvailable(ver - 3, hor))
                {
                    ...
                    m_cells[ver - 2][hor].m_is_ship = true;
                    m_cells[ver - 2][hor].m_ship_index = cur_ship_index;
                    m_cells[ver - 3][hor].m_is_ship = true;
                    m_cells[ver - 3][hor].m_ship_index = cur_ship_index;
                    is_found = true;
                }
